import Characters from '../../../src/constants/fonts/characters';
...
describe('Characters', () => {
  ...
  it('contains all available characters', () => {
    expect(Characters).toEqual([
      ...
      'Euro', '.notdef', 'quotesinglbase', 'florin', 'quotedblbase', 'ellipsis', 'dagger',
      'daggerdbl', 'circumflex', 'perthousand', 'Scaron', 'guilsinglleft', 'OE', '.notdef',
      'Zcaron', '.notdef', '.notdef', 'quoteleft', 'quoteright', 'quotedblleft', 'quotedblright',
      'bullet', 'endash', 'emdash', 'tilde', 'trademark', 'scaron', 'guilsinglright',
      'oe', '.notdef', 'zcaron', 'ydieresis', 'space', 'exclamdown', 'cent', 'sterling',
